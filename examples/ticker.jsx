...
<h4>Challenge</h4>
<p>Try adding a field into the state which affects how much the <code>state.ticks</code> is incremented every second. Maybe reuse the buttons from the counter example for the controls!</p>
*****/
